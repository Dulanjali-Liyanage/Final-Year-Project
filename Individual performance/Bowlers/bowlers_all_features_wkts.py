...
Original file is located at
    https://colab.research.google.com/drive/1-i7BS6SBCbizTBexcZplp3CxUup2solo
"""
...
feature_names = ["Man of the match", "4", "Height (cm)", "Bowling Style","5", "Econ", "Hat tricks", "SR", "Mat", "Inns", "Ave", "BBI-calc"]
X = df[feature_names]
Y = df["Wkts"]
...
df['Bowlers_score'] = df['Man of the match']*thisdict['Man of the match']+df['4']*thisdict['4']+df['Height (cm)']*thisdict['Height (cm)']+df['Bowling Style']*thisdict['Bowling Style']+df['5']*thisdict['5']+df['Econ']*thisdict['Econ']+df['Hat tricks']*thisdict['Hat tricks']+df['SR']*thisdict['SR']+df['Mat']*thisdict['Mat']+df['Inns']*thisdict['Inns']+df['BBI-calc']*thisdict['BBI-calc']+df['Ave']*thisdict['Ave']
...
df1.to_csv('bowlers_allfea_wkts_score.csv' , index=False)
files.download('bowlers_allfea_wkts_score.csv')