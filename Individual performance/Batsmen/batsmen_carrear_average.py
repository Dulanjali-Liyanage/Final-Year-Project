# -*- coding: utf-8 -*-
"""Batsmen_carrear_average.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/10lAct2-BHICRXukKT5HXNyIALEfgw4fY
"""
...
carrear_feature_names = ["Man of the match", "Last 4 match runs mean", "Height (cm)", "Batting Style", "Runs", "NO", "HS", "HS_NO", "SR", "100", "50", "0"]
...
df['Batsmen_score'] = df['Man of the match']*thisdict['Man of the match']+df['Last 4 match runs mean']*thisdict['Last 4 match runs mean']+df['Height (cm)']*thisdict['Height (cm)']+df['Batting Style']*thisdict['Batting Style']+df['Runs']*thisdict['Runs']+df['NO']*thisdict['NO']+df['HS']*thisdict['HS']+df['HS_NO']*thisdict['HS_NO']+df['SR']*thisdict['SR']+df['100']*thisdict['100']+df['50']*thisdict['50']-df['0']*thisdict['0']

df.head(15)

df['Batsmen_score'] = df['Batsmen_score']/10
...
final_df = final_df.sort_values(by=['Batsmen_score'], ascending=False)

final_df.head(20)

df1 = final_df[['player', 'Batsmen_score']]

df1.head(30)

from google.colab import files
df1.to_csv('batsman_carrear_ave_score.csv' , index=False)
files.download('batsman_carrear_ave_score.csv')

from google.colab import files
df.to_csv('carrear_batsman_ave_score_original.csv' , index=False)
files.download('carrear_batsman_ave_score_original.csv')

df['Batsmen_score2'] = df['Man of the match']*thisdict['Man of the match']+df['Last 4 match runs mean']*thisdict['Last 4 match runs mean']+df['Height (cm)']*thisdict['Height (cm)']+df['Batting Style']*thisdict['Batting Style']+df['Runs']*thisdict['Runs']*0.01+df['NO']*thisdict['NO']+df['HS']*thisdict['HS']+df['HS_NO']*thisdict['HS_NO']+df['SR']*thisdict['SR']+df['100']*thisdict['100']+df['50']*thisdict['50']-df['0']*thisdict['0']

df.head(20)

final_df2 = df.sort_values(by=['Batsmen_score2'], ascending=False)

df2 = final_df2[['player', 'Batsmen_score2']]
